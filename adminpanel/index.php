...
<body>
    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-12 mb-3">
                <div class="summary-pembeli pt-3">
                    <div class="row">
                        <div class="col-6">
                            <i class="fas fa-align-left  fa-7x text-black-50"></i>
                        </div>
                        <div class="col-6 text-white">
                            <h3 class="fs-2">Pembeli</h3>
                            <p class="fs-4"><?php echo $jumlahPembeli; ?> Pembeli</p>
                            <p><a href="pembeli.php" class="text-white no-decoration">Lihat Detail</a></p>
                        </div>
                    </div>
                </div>
            </div>
